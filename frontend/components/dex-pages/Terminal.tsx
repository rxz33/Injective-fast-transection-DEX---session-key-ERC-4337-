          ...
          <div className="flex flex-col">
            ...
            <span
              className={`font-mono text-lg ${
                change24h >= 0 ? "text-accent" : "text-danger"
              }`}
            >
              {change24h >= 0 ? "+" : ""}
              {change24h.toFixed(2)}%
            ...
            <div className="flex gap-2">
              {["1M", "5M", "15M", "1H", "1D"].map((t) => (
                <button
                  ...
                  className={`px-2 py-1 text-[10px] font-bold rounded transiton-all ${
                    t === timeframe
            ...
            <div className="flex flex-col gap-2 p-3 bg-accent/5 rounded-xl border border-accent/10">
              <div className="flex justify-between text-[10px] font-bold uppercase tracking-tighter">
                ...
                <span className="text-foreground font-mono">
                  ${(Number(buyQty || 0) * midPrice).toFixed(2)}
                </span>
              </div>
              <div className="flex justify-between text-[10px] font-bold uppercase tracking-tighter">
                ...
                <div className="flex items-center gap-2">
                  <div
                    className={`h-2 w-2 rounded-full ${
                      row.side === "BUY" ? "bg-accent" : "bg-danger"
                    }`}
                  />
                  <span
                    className={`font-bold uppercase tracking-tighter ${
                      row.side === "BUY" ? "text-accent" : "text-danger"
                    }`}
                  >
                    {row.side}
                  </span>
